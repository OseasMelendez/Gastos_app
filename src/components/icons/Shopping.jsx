const Shopping = ({ size = 24, color = "currentColor"}) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M641 960.2H136.7c-39.6 0-71.8-32.1-71.8-71.8v-674H641v745.8z"
      fill="#4D96FF"
    />
    <path
    ...
    />
    <path
      d="M890.8 959.6H392.4c-39.4 0-71.4-32-71.4-71.4v-440h641.3v439.9c-0.1 39.5-32 71.5-71.5 71.5z"
      fill="#03cb28"
    />
  </svg>
);
